function res = gen_inter_data(params, out)
    ...
    for i = 1:length(params.nl_effect)
        ...
        %[T1_lenna1, T2_lenna1] = GetThresholds(phi_max_lenna1, params.method) ; 
        %[T1_lenna2, T2_lenna2] = GetThresholds(phi_max_lenna2, params.method) ; 
        %[T1_fish1, T2_fish1] = GetThresholds(phi_max_fish1, params.method) ; 
        %[T1_fish2, T2_fish2] = GetThresholds(phi_max_fish2, params.method) ; 

        lenna_extract1 = make_edges(phi_max_lenna1a,phi_max_lenna2a, T1_lenna, T2_lenna) ; 
        lenna_extract2 = make_edges(phi_max_lenna1b,phi_max_lenna2b, T1_lenna, T2_lenna) ;

        fish_extract1 = make_edges(phi_max_fish1a, phi_max_fish2a, T1_fish, T2_fish) ; 
        fish_extract2 = make_edges(phi_max_fish1b, phi_max_fish2b, T1_fish, T2_fish) ; 
